...
*This value describes how acoustic a song is. A score of 1.0 means the song is most likely to be an acoustic one. I build a ridge plot roduce an overview of acousticness and check on my own assumption which album has the biggest value.*
